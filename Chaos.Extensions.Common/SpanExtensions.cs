...
public static class SpanExtensions
{
    ...
    /// </summary>
    /// <param name="span">The span to check for the string</param>
    /// <param name="str">The string to check for</param>
    /// <returns><c>true</c> if the string was found in the span regardless of case, otherwise <c>false</c></returns>
    ...
    /// <param name="span">The span to check for the string</param>
    /// <param name="str">The string to check for</param>
    /// <returns><c>true</c> if the string was at the end of the span regardless of case, otherwise <c>false</c></returns>
    ...
    /// <param name="str">The string to check for</param>
    /// <returns>
    ///     <c>true</c> if the string was found at the beginning of the span regardless of case, otherwise <c>false</c>
    /// </returns>
