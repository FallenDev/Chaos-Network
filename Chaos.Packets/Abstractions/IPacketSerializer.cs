...
public interface IPacketSerializer
{
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The type of object to deserialize the packet into, which must implement 
    ///     <see cref="IPacketSerializable"/>.
    /// </typeparam>
    /// <param name="packet">
    ...
    /// <summary>
    ///     Serializes the specified object implementing <see cref="IPacketSerializable"/> into a 
    ///     server packet.
    /// </summary>
    /// <param name="obj">
    ...
    /// </param>
    /// <returns>
    ///     A packet representing the serialized <paramref name="obj"/>.
    /// </returns>
